...
<div class="sideNav">
    ...
    <ul>
        <!-- Lien vers accueil -->
        <li><a href="accueil.php">Parcourir</a></li>
...
<div class="main" id="main">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="infosCell"><!-- informations sur la série -->
                <!-- rajouter ul, li  etc. pour différentes infos -->
            </div>
        </td>
    </tr>
    ...
    <div id="serieInfos">
        <h2 id="nameSerie"><!-- titre de la série --></h2>
        <div id="imageInfos"><!-- image --></div>
        <div id="InfosInfos"><!-- informations sur la série -->
            <ul id="listInfos">
                <!-- chaque information est dans un li -->
            </ul>
        </div>
    </div>
